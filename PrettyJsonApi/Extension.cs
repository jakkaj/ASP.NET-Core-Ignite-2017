...
//Thanks to Jargon64! Life saver!
//https://gist.github.com/Jargon64/5b172c452827e15b21882f1d76a94be4
namespace PrettyJsonApi
{
    public static class RSACryptoServiceProviderExtensions
    {
        public static void FromBase64String(this RSACryptoServiceProvider rsa, string b64String)
        {
            var normal = Encoding.UTF8.GetString(Convert.FromBase64String(b64String));
            FromXmlString(rsa, normal);
        }
